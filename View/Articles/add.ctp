...
<div class="page-header">
	<h1>
		<?php echo __('New Article',true);?>
		<small>
			|
			<a href="<?php echo $this->webroot;?>articles/index">	<?php echo __('All Articles',true);?></a>
		</small>
	</h1>
</div>
		...
		<div class="col-xs-12">
			...
			<div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9"><?php echo $this->Form->input("excerpt" ,array('label' => false, 'maxlength' => '150', 'type'=>'textarea','div' => false,'class'=>"umstyle5" ))?>
						<span style="color: grey; font-size: 12px; padding-left: 10px;"> Max lenght (150 char) </span></div>
					<div style="clear:both"></div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9"><?php echo $this->Form->input("category_id" ,array('label' => false, 'type'=>'select', 'placeholder'=>'Category', 'options'=>$categories, 'div' => false))?></div>
					<div style="clear:both"></div>
				</div>

				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right text-right" for="form-field-1"> Tags</label>
					<div class="col-sm-9">
				...
				<figure class="span12" style="margin-top: 5%;">
					<div class="form_holder" id="image">
						...
						<div class="span3">
							<div class="image-placeholder image-placeholder2 second">Dimensions</div>
							<div class="span9" style="margin-left: 25%;">
