	...
	<section id="pantalla3" style="position:relative;">
		...
		<div class="firtsContent3" style="width: 1060px; margin:0 auto; padding-top:60px;">
			<div class="iconsI" style="float:left;">
				<img style="cursor:pointer;" onclick="window.location.href = WEBROOT+'start/careerGuidance/big_picture'" src="<?php echo $this->webroot.'img/index/big_picture_index.png';?>">
				<img onclick="window.location.href = WEBROOT+'start/careerGuidance/self_knowledge'" class="secondImg3" style="cursor:pointer; padding-left: 80px;" src="<?php echo $this->webroot.'img/index/know_yourself_index.png';?>">	
			</div>	

			<div class="iconsI secondGroup3" style="float:left;">
				<img onclick="window.location.href = WEBROOT+'start/careerGuidance/how_to_choose'" style="cursor:pointer;  padding-left: 80px;"  src="<?php echo $this->webroot.'img/index/how_to_choose_index.png';?>">			
				<img onclick="window.location.href = WEBROOT+'start/careerGuidance/job_hunting'" class="secondImg3" style="cursor:pointer;  padding-left: 80px;"  src="<?php echo $this->webroot.'img/index/job_hunting_index.png';?>">			
			</div>
...
<script>
	...
	$('.landingRedirect').click(function(){
		window.location.replace(WEBROOT+'Start/landing');
	})
	...
	$('.career_information').click(function(){
		window.location.replace(WEBROOT+'Start/careerGuidance');
	})
