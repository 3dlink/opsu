...
<head>
	...
	<?php 
		echo $this->Html->css('../library/bootstrap/css/bootstrap.css');
	 	echo $this->Html->css('landing_help.css');
	...
	<div id="fondo">
		<div id="degradado">
			...
			<section id="pantalla1">
				<div id="titulo">The Career	Decision-Making Program
					<div id="arrow"></div>
				</div>
	...
	<section id="pantalla_movil">
			<div id="formulario_2">
					...
					<div id="form" style="height: 45%;">
						...
						<input id="movil_password" class="input_form" type="password" placeholder="Password">
						...
						<div class="selects">
							<input id="movil_state" class="inI selt states input_form" style="float:initial;" readonly data-educa="0" placeholder="State">
							<div class="btn-group doa" style="">
								<span class="spanEduca down flagRow dropdown-toggle btn_dropdown" data-toggle="dropdown" tabindex="-1" >
									<img style="width: 20px;" src="<?php echo $this->webroot.'img/down-menu.png';?>">
								</span>
	...
	<section id="pantalla2">
		...
		<div id="boton">
			<div class="boton_content">
				...
				<div id="mini_letras_2" style="font-weight: 300; font-size: 16px;">Complete it at your own rithm.</div>
			</div>
		</div>
	</section>
