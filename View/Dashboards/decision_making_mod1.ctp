	...
	<div>
		...
		<div id="menuUserDashboard" style="color: #B0B0B0;">
			...
			<div class="option active">
				<?php echo __('My carrer vision',true);?>
				<div></div>
			</div>
		</div>
	</div>
	...
	<div class="contenedor_secciones">
		<section class="seccion_izquierda video">
			<div id="contenedor_video">
					...
					<div id="link">
						<a href="<?php echo $this->webroot;?>dashboards/quest_mod1">Continue this module</a>
					</div>
					</div>
		...
		<section class="seccion_derecha">
			<article id="article_tips">
					...
					<div style="text-align: center; font-size:16px;">
						<button type="button" onclick="window.location.href='<?php echo $this->webroot;?>dashboards/quest_mod1'" class="quiz-result-btn boton_module">
