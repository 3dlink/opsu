...
.lineas{
	width: 330px; height: 2px;margin: 0 20px; background-color: #d0d0d0;
}
.seccion_derecha {
...
@media (max-width: 750px){
	...
	#dash_content #menu-content-mobile ul li ul li a {
	  padding-left: 20px;
	  margin-left: 0px;
	}
	.seccion_derecha{
...
<div id="menuUserDashboard2" style="  padding-left: 22px;">
...
<div id="allContentMentoring" style="float:left; font-size:16px;  margin-left:30px; color:black; width:570px;">
	...
	<div style="margin-top:18px;text-align:justify;">
		Our team strives to connect protégés with mentors who work in an appropriate field, who have faced comparable challenges and who share similar values.<br /> <br />
		Please provide some details about yourself to help ensure we make the best possible match: 
		<br /><br />
	</div>
<!-- 1 -->
	<div class="rowMentoring">
		<div class="titleRow">Which of the following best describes you?</div>
		<div class="formRow">
...
<!-- 3 -->
	<div class="rowMentoring Q3" style="display:none;">
		<div class="titleRow YS">Year of study</div>
		<div class="formRow selects yearV2">
			<input style="color:black; float: left;   padding-left: 10px;  width: 27%; margin-bottom: 25px;" id="YW" class="inI selt yearV" readonly="" data-year="0" value="1st">
			<div class="btn-group doa " style="">
				<span style="margin-top: 7px; display: block; margin-left: -20px;" class="YSdoa spanEduca down flagRow dropdown-toggle" data-toggle="dropdown" tabindex="-1">
					<img style="width: 20px;" src="<?php echo $this->webroot;?>img/down-menu.png">
				</span>
				<ul class="dropdown-menu dropdown-menuYear">
...
<!-- 4 -->	
	<div class="rowMentoring">
		<div class="titleRow">
			<div style="margin-bottom: 10px;">Challenges you are facing </div>
			<div style="font-weight:300; margin-right: 7px;">We will do our best to match you with a mentor that has faced similar challenges</div>
		</div>
		<div class="formRow">
			<div style="width: 80px;" class="optionValue" data-active="0" >Gender</div>
			<div style="width: 160px; margin-left:10px; margin-right:10px;" class="optionValue" data-active="0" >Sexual orientation</div>
			<div style="width: 90px;" class="optionValue" data-active="0" >Network</div>
			<div style="width: 100px;" class="optionValue" data-active="0">Relocation</div>
			<div style="width: 140px; margin-left:10px; margin-right:10px; font-size: 14px" class="optionValue" data-active="0" >Physical disability</div>
			<div style="width: 90px;" class="optionValue" data-active="0" >Ethnicity</div>
			<div style="width: 130px; padding: 5px 0px 5px 0px;" class="optionValue" data-active="0" >Drugs / addiction</div>
			<div style="width: 70px; margin-left:10px; margin-right:10px;" class="optionValue" data-active="0" >Money</div>
			<div style="width: 130px; padding: 5px 0px 5px 0px;" class="optionValue" data-active="0" >Family pressure</div>
			<div style="width: 170px;" class="optionValue" data-active="0" >Gangs / violence</div>
			<div style="width: 170px; margin-left:10px;" class="optionValue" data-active="0" >Lack of experience</div>
			<div style="width: 150px;" class="optionValue" data-active="0" >Lack of direction</div>
			<div style="width: 110px; margin-left:10px; margin-right:10px;" class="optionValue" data-active="0" >Self-doubt</div>
			<div style="width: 70px;" class="optionValue Other" data-active="0" >Other</div>
			<div style="display:none; margin-bottom:20px;" class="challengesOther" > <input style="width: 95%;"> </div>
		</div>
	</div>
	<div style="clear:both"></div>
...
<!-- 5 -->	
	<div class="rowMentoring">
		<div class="titleRow">
			<div style="margin-bottom: 10px;">What are your targeted positions/occupations?</div>
			<div style="font-weight:300;">We will match you with mentors working in these industries</div>
		</div>
		<div class="formRow"> 
			<div style="width: 100%;">
				<div class="PyO"><input style="margin-bottom:20px; width: 95%;"> </div>
				<div class="PyO"><input style="margin-bottom:20px; width: 95%;"> </div>
				<div class="PyO"><input style="margin-bottom:20px; width: 95%;"> </div>
				<div class="PyO inputMore1" ><input style="margin-bottom:20px; width: 95%;"> </div>
				<div class="PyO inputMore2" ><input style="margin-bottom:20px; width: 95%;"> </div>
...
<!-- 6 -->	
	<div class="rowMentoring">
		...
		<div class="formRow" style="margin-bottom: 20px;"><textarea id="interest" style="  border: 1px solid; width:350px; height: 115px; resize:none;"></textarea> </div>
	</div>
	<div style="clear:both"></div>
<!-- 7 -->	
	<div class="rowMentoring">
		<div class="titleRow" style="margin-bottom: 20px;">Do you have a gender preference?</div>
...
<!-- 8 -->	
	<div class="rowMentoring" style="margin-top: 60px;">
...
<!-- 9 -->	
	<div class="rowMentoring" style=" min-height:95px;margin-top: 60px;">
		<div class="titleRow" style="margin-bottom: 20px;">In which state do you currently reside?</div>
		<div class="formRow selects one stados">
			<?php 
				$stat = "Select one...";
				$idState = "0";
				$li2 = "";
...
<!-- Rules -->	
	<div class="rowMentoring">
		<div>
			<div class="rules"><?php echo $this->Html->image('dashboard/Rectangulo2020.png');?></div>
			<div style="text-align:justify; margin-bottom:20px; margin-left:40px;">I understand that my mentor has volunteered to participate in the Program and that the relationship is learning based. The Mentoring Program is not an employment placement program </div>
		</div>
		<div>
			<div class="rules"><?php echo $this->Html->image('dashboard/Rectangulo2020.png');?></div>
			<div style="text-align:justify; margin-bottom:20px; margin-left:40px;">I understand that registering for the Mentoring Program does not guarantee participation if MENTOR. is unable find a suitable match.
			</div>
		</div>
		<div>
			<div class="rules"><?php echo $this->Html->image('dashboard/Rectangulo2020.png');?></div>
			<div style="text-align:justify; margin-bottom:20px; margin-left:40px;">I understand that I must take ownership of arranging meeting, times and locations.</div>
		</div>
	</div>

	<div style="text-align: center;">
		<button style="font-size:16px; font-weight:bold; height: 60px; width:  175px; margin-bottom:60px;" type="button" class="save quiz-result-btn">
			SUBMIT
		</button>
	</div>
	...
	<section class="seccion_derecha" style="height: 1551px;">
		...
		<div style="margin-top: 40px;" class="lineas"></div>
		<div style="clear: both;"></div>

		<div id="carousel-example-generic"
			style="width: 370px; height: 280px; padding-top: 0px;padding-left:5px;"
...
<script type="text/javascript"> 
	...
	$('a').click(function(){
		$('body').click();
		$('.down > img').each(function(k,v){
			$(this).attr('src', WEBROOT+"img/down-menu.png");
	}) 
})
	...
	$('.down').click(function(){
		if($(this).find('img').attr('src') == WEBROOT+"img/down-menu.png"){
			...
			if($('body').width() <= 750){
				$('.dropdown-menu').width( ($('.stados').width()-10) );
			}
		}
		else{
			$(this).find('img').attr('src', WEBROOT+"img/down-menu.png");
	...
	$('.mthodC').click(function(){
		if( $(this).find('img').attr('src') == WEBROOT+"img/dashboard/Rectangulo2020.png" ){
			$(this).find('img').attr('src', WEBROOT+'img/dashboard/Check2.png');
		}
		else{
			$(this).find('img').attr('src', WEBROOT+"img/dashboard/Rectangulo2020.png");
		}
	})
...
if(pasa){
		...
		var data = {
			...
			gender : gender,
			user_id: "<?php echo $this->UserAuth->getUserId();?>"
		}
		var dataUser = {
			state_id: state,
		...
		$.ajax({
			url: WEBROOT+"dashboards/mentoringSave",
...
function acceptRules(){
	$('#modalMsg').html('Please accept all the terms to proceed');
	$('#openModal').click();
}
...
$('#menu_content').height($('#info_content').height());
