...
<section class="container" id="quiz-container">
	...
	<form action="">
		<div class="mentr-quiz-content col-sm-offset-0 col-md-offset-1 col-xs-12 col-sm-12 col-md-11" >
			...
			<div class="question" id="question2">
				...
				<div class="mentr-quiz-respond">
					<div class="mentr-quiz-feel">
						<div class="col-xs-12 col-sm-4 mentr-quiz-feel-option">
						...
						<div class="col-xs-12 col-sm-4 mentr-quiz-feel-option">
							...
							<div class="mentr-quiz-feel-respond">
								...
								<small class="mentr-desc-btn">
									<label>I have too many ideas</label>
								</small>
							</div>
						</div>
						<div class="col-xs-12 col-sm-4 mentr-quiz-feel-option">
							...
							<div class="mentr-quiz-feel-respond">
								...
								<small class="mentr-desc-btn">
									<label>I have a reasonable clear idea</label>
								</small>
							</div>
						</div>
			...
			<div class="question" id="question_break">
				<div>
					<h3 class="mentr-quiz-question" style="font-weight: inherit; font-size: 26px;">
						<small>
							<span id="index_A"></span>
							<span class=""></span>
						</small> 
						"To find out what one is fitted to do, and to secure and opportunity to do it, the key to happiness"
						<br>
						<small>
							john dewey
						</small>
			...
			<div class="question" id="question24">
				<div>
					<label class="mentr-quiz-question">
						...
						We will send you a summary of this assessment by email.	 Please indicate us you email address
					</label>
				</div>
				<div class="mentr-quiz-respond">
...
<nav id="mentr-quiz-nav">
	<div class="container">
		<div class="mentr-quiz-content col-xs-6">
		...
		<div class="mentr-quiz-content col-xs-6" style="text-align: right;" >
